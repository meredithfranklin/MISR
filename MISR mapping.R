...
aqspm25.points<-unique(misr.aqspm25[,38:39]) # misr matched
aqspm25.points2<-unique(aqspm25_06_11[,2:3]) # all
#write.csv(aqspm25.points2,'PM25_sites_06_11.csv',row.names=FALSE)
aqspm10.points<-unique(misr.aqspm10[,38:39]) # misr matched
aqspm10.points2<-unique(aqspm10_06_11[,2:3]) # all
#write.csv(aqspm10.points2,'PM10_sites_06_11.csv',row.names=FALSE)
aqspm10.pm25.points<-unique(misr.aqspm1025[,22:23]) # misr matched
aqspm10.pm25.points2<-unique(aqspm10_pm25_06_11[,1:2]) # all
...
# Maps of model predictions PM2.5
